...
resource aiAccount 'Microsoft.CognitiveServices/accounts@2026-05-01' existing = {
...
@batchSize(1)
resource seqDeployments 'Microsoft.CognitiveServices/accounts/deployments@2026-05-01' = [
...
output speechToTextEndpoint string = 'https://${aiAccount.properties.customSubDomainName}.cognitiveservices.azure.com/'
output textToSpeechEndpoint string = 'https://${aiAccount.properties.customSubDomainName}.cognitiveservices.azure.com/'
output voiceLiveEndpoint string = 'https://${aiAccount.properties.customSubDomainName}.cognitiveservices.azure.com/'
