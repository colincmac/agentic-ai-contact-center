...
namespace Agents.AI.Monitoring.Teams;


public record TeamsPhoneCallerDetails(string CallerId, string CallerName, string CallerLocation, string CallerLanguage);
public record TeamsPhoneSourceDetails(string SourceId, string SourceName, string SourceLocation, string SourceLanguage);

/// <summary>
/// TeamsPhoneCallDetails.
/// </summary>
public sealed class TeamsPhoneCallDetails
{
    ...
    /// <param name="suggestedActions"> Recommendations for resolving the issue based on the caller's intent and interaction history. </param>
    ...
    public TeamsPhoneCallerDetails? TeamsPhoneCallerDetails { get; set; } = null;

    /// <summary> Container for details relating to the entity responsible for the creation of these call details. </summary>
    public TeamsPhoneSourceDetails? TeamsPhoneSourceDetails { get; set; } = null;
    ...
    /// <summary> Recommendations for resolving the issue based on the caller's intent and interaction history. </summary>
